    ...
    def start_execution(self):
        ...
        if self.task_list:
            ...
            self.thread_p1 = RunProgress(
                self.task_list[0], self.label_state_p1, self.signal_p1)
            ...
            self.thread_p2 = RunProgress(
                self.task_list[1], self.label_state_p2, self.signal_p2)
            ...
            self.thread_p3 = RunProgress(
                self.task_list[2], self.label_state_p3, self.signal_p3)
            ...
            self.thread_p4 = RunProgress(
                self.task_list[3], self.label_state_p4, self.signal_p4)
