...
class FIFOMainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.button_assign.clicked.connect(self.assign_tasks)
        self.button_execute.clicked.connect(self.start_execution)
    ...
    def start_execution(self):
        ...
        if self.task_list:
            ...
            self.label_state_p1.setText('En Ejecucion')
    ...
    def finish_p1(self):
        ...
        self.label_state_p2.setText('En Ejecucion')
    
    def finish_p2(self):
        self.thread_pool.start(self.thread_p3)
        self.label_state_p3.setText('En Ejecucion')
    
    def finish_p3(self):
        self.thread_pool.start(self.thread_p4)
        self.label_state_p4.setText('En Ejecucion')
